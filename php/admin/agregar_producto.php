...
<form action="Agregar_pro.php"method="POST">
    ...
    <div class="row">
        ...
        <input type="text" class="form-control" name="producto_pro" placeholder="Nombre" maxlength="100" required="">
        </div>
        <div class="col">
        <label for=""><b>Descripcion</b></label>
        <input type="text" class="form-control" name="descripcion_pro" placeholder="Descripcion" maxlength="100" required="">
        </div>
    ...
    <div class="row">
        ...
        <input type="number" class="form-control" name="precio_pro" placeholder="Precio" step="0.01" maxlength="20" required="">
        </div>
        </div>
        <div class="col">
        <label for=""><b>Stock</b></label>
        <input type="number" class="form-control" name="stock_pro" placeholder="Stock" maxlength="40" required="">
        </div>
    ...
    <div class="row">
        ...
        <input type="text" class="form-control" name="categoria_pro" placeholder="Categoria" maxlength="50" required="">
        </div>
